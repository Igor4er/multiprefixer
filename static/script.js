...
let next_url = base_url + "/prefixer/next"
let previous_url = base_url + "/prefixer/previous"
let delete_url = base_url + "/prefixer/delete"
let underscore_url = base_url + "/prefixer/underscore"
...
function getPhoto() {
    ...
    let photo_url = "http://127.0.0.1:5000/api/photo";
...
function next() {
    let index_now = parseInt(getCookie("index"));
    let index_after = index_now + 1;
    index_after = '' + index_after;
    setCookie("index", index_after, "session")
    getPhoto();
}
